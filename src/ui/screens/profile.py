                    ...
                    with VerticalScroll(id="profile-list"):
                        for name in self.profiles.keys():
                            with Horizontal(classes="profile-item"):
                                ...
                                yield Button("Load", variant="primary", id=f"load-{name}", classes="btn-load")
                                yield Button("Delete", variant="error", id=f"delete-{name}", classes="btn-delete")
    ...
    def _refresh_list(self) -> None:
        ...
        for name in self.profiles.keys():
            with Horizontal(classes="profile-item"):
                ...
                lst.mount(Button("Load", variant="primary", id=f"load-{name}", classes="btn-load"))
                lst.mount(Button("Delete", variant="error", id=f"delete-{name}", classes="btn-delete"))
